...
% add more space between equations
\addtolength{\jot}{1pt}
...
\graphicspath{{./images/} {./images/cover/} {./images/chapter_2/} {./images/chapter_3/} {./images/chapter_4/}}
...
\usepackage[format=hang,labelfont=bf,font=small, skip=10pt]{caption}
...
% \usepackage[numbered]{./formating/mcode}
%
% -----------------------------------------------------------------------------
...
\hypersetup{colorlinks=true,
            ...
            bookmarksopen=true,
            pdftitle={Artur's Thesis},
            pdfauthor={Artur Rafael},
            pdfcreator={Artur Rafael}
}
%
% -----------------------------------------------------------------------------
% PACKAGE url:
...
\newcommand{\chapterpreamble}[1]{ %
    ...
    #1 \\
    \noindent \textsuperscript{\rule{\textwidth}{0.5pt}}
}
